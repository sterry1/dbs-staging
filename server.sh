...
docker run -d --name="$container" -v $host_datadir:$container_datadir -v $(pwd)/trunc-core-data-7.23.sql:/tmp/core-data.sql  -v $(pwd)/my.cnf:/etc/mysql/my.cnf -p 3306:3306 -p 4444:4444 -p 4567:4567 $image
